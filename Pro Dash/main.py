...
st.title("Sentiment Analysis Dashboard for US Airlines")
...
st.markdown("### Number of tweets by sentiment  &nbsp;&nbsp;&nbsp;        Total number of Tweets &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      For Each Airline")
if select == 'Bar plot':
...
if each_airline == 'Bar plot':
    ...
    fig_1 = px.bar(airline_sentiment_count, x='Airline', y='Tweets', color='Airline', height=500)
        
if each_airline == 'Pie chart':
    fig_1 = px.pie(airline_sentiment_count, values='Tweets', names='Airline')
